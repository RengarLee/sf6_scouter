...
- **添加随机角色推荐**：用户可以在Home-其他页面中点击随机角色按钮获得随机推荐的角色。这个随机每个角色的概率都是平等的，并不像官网一样优先推荐对战数少的。
  <sub>🙌 特别感谢 QQ 王小川 提供的建议</sub>

### 优化
-**DPI适配优化**：优化了应用在高DPI屏幕上的显示效果，确保界面元素清晰且布局合理。
  <sub>🙌 特别感谢 QQKano 提供的反馈</sub>

### 修复
- **修复跟踪起点角色列表为空的问题**：修复了当跟踪起点角色列表为空的问题，确保功能正常运行。
